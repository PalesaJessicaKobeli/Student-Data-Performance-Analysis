# Student Performance Analysis Idealnovate Project

## Project Overview
This project analyzes a student performance dataset (1001 records) covering demographics, socio-economic indicators, and academic scores across math, reading, and writing. The dataset was cleaned and explored, then visualized in an interactive **Power BI** dashboard titled *Student Performance Dashboard*.
...
| Column | Description |
|---|---|
| `gender` | Encoded gender (0 -Females/ 1 -Males) |
...
- Total math scores are fairly balanced between the two gender groups, with only a small gap (~165 points across 1001 students).
...
## Author
Palesa Jessica Kobeli

## Status
Completed — Project 1 of the data analysis series from Idealnovate
